...
function SidebarProvider({
  ...
  const setOpen = useCallback(
    (newValue: boolean | ((prevOpen: boolean) => boolean)) => {
      const openState =
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: Legacy cookie management pattern, consider migrating to Cookie Store API
