...
export default function Home() {
  return (
    <div className="mx-auto grid min-h-screen w-full max-w-7xl grid-rows-[20px_1fr_20px] items-center justify-items-center gap-16 p-8 pt-24 pb-20 font-sans sm:p-20 sm:pt-32">
